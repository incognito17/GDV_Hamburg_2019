...
- Weitere Anmerkungen bzgl. Implementierung:
    ...
    - Struktur:
        - Es gibt eine Hauptdatei "index.html", welche den Start der Web-Anwendung aufruft. Diese beinhaltet hauptsächlich HTML-Code. Diese inkludiert (neben den oben erwähnten runtergeladenen Bibliotheken) drei JS-Dateien: *functions.js*, *piechart.js* und *scatterplot.js*
