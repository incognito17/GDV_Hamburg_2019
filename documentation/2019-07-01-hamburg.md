...
<!--- 
 ...
 <!---
 - Vergnügungsviertel richtiges Wort? (Nicht Unterhaltungsviertel)
 - Scatterplot ist leicht verzerrt
 - "Untertitel ist komisch" (ggf. anders formulieren -- "Zentralität" oder "Vergleich")
 - Rot im Farbschema, der Karte im Plakat verwirrend. (Hervorhebung aus dem Bild nehmen)
 - ggf. Hervorhebungsfarbe zu Grün ändern oder hinzuschreiben, dass Hervorgehoben wurde.
 - Schrift aus Bild rausnehmen, lieber als Bilduntertitel setzen und was anderes
 - ggf. mehr Text, Scatterplot kann man verkleinern
 - Nicht Trend signifikant, sondern Korrelation (linerale regressionsanalyse)
 - Regressionslinie im Poster einzeichnen (d.h. Korrelationsgrade im Bild beim Scatterplot mit rho)
 - Bild ggf. mit Legende versehen
 - Dokumentation: Punkt "Einschränkungen" hinzufügen. D.h. was war möglich, was nicht, was könnte noch gemacht werden?
 - POIs und Unterhaltungsangebote identisch, das auch anzeigen.

 - Zum eigentlichen Projekt:
    - Rahmen der Karte wegmachen
    - bitte das Scatterplot unten lassen
    - Verbindung/Cross-Image-Markierungen 
    - DropDown ggf. nach oben nehmen; Sichtbar machen. Bestenfalls direkt an die Locations Karte.
    - Locations umbenennen zu Unterhaltungsangebote oder POIs.
    - Warum ändert sich die Farbe bei den Selektionen? (Skorna meint: Ist eigentlich ganz hübsch.)
    - Tooltip mit Offset generieren (leicht nach rechts, dass es nicht auf der Maus ist)
    - Den blauen Punkten eine weiße Outline geben.
