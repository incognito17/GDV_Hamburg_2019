...
- Weitere Anmerkungen bzgl. Implementierung:
    ...
    - Struktur:
        - Es gibt eine Hauptdatei "index.html", welche den Start der Web-Anwendung aufruft. Diese beinhaltet hauptsächlich HTML-Code. Sie bindet auch die entsprechende Style-CSS Datei ein, welche die Darstellung der Web-App anpassen. Diese inkludiert (neben den oben erwähnten runtergeladenen Bibliotheken) drei JS-Dateien: *functions.js*, *piechart.js* und *scatterplot.js* (Für genauere Informationen und Details siehe Beschreibeung + Kommentare in den jeweiligen Code-Dateien und den eigentlichen Code selbst).
            ...
            - scatterplot.js: Hier wird der Scatterplot (sowie auch Tooltips dazu) aufgebaut. Größe, Positionen, Achsen und Achsenbeschriftungen werden erstellt + das Ganze wird mit den entsprechenden Daten verbunden (Genauere Details und Infos, siehe Code selbst und Codestruktur - ich hab noch einige Kommentare dort ausformulliert)
    - Probleme bei D3:
        - **Wirklich** schlecht / problematisch war, dass von D3-Version *3.xx* zu *5.xx* es GEWALTIGE Unterschiede gibt, Ganze Funktionen heißen anders, manche Funktionen sind weggefallen oder werden anders verwendet (sodass eig. D3 3.xx und D3 5.xx fast komplett verschiedene Bibliotheken sind). Die D3-Homepage wird allerdings anscheinend nicht gescheit aktualisiert. Die ganzen Beispiele dort, Tutorials, Beschreibungen (zumindest die, die ich mir zu Scatterplots angeschaut habe) **sind zu v3.xx**. Auch sehr viele Tutorials/Beschreibungen auf anderen externen Seiten sind auf 3.xx-Stand (für Version 5.xx ist es irgendwie sehr schwer was zu finden) - sodass es sehr frustrierend und nervig für Einsteiger (welche ich/wir ja eig. sind) ist: Man ladet die aktuellste Version runter - kann aber mit Tutorials/Forumbeiträgen/Erklärungen nichts anfangen. Man ist gezwungen auf die Version 3.xx "runter" zu wechseln, um überhaupt irgendwelche Visualisierungen als Anfänger hinkriegen zu können
